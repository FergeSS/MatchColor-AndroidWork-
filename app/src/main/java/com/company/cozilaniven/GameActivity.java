...
import static com.company.cozilaniven.Settings.action;
import static com.company.cozilaniven.Settings.fireworkSound;
...
import com.company.cozilaniven.databinding.ActivityGameBinding;
import com.company.cozilaniven.databinding.ActivityMainBinding;
...
public class GameActivity extends AppCompatActivity {
    ...
    private void getCoord() {
        binding.row1col1.getLocationOnScreen(coordBall1);
        coordBall1[0] += binding.row1col1.getWidth() / 2;
        binding.row1col2.getLocationOnScreen(coordBall2);
        coordBall2[0] += binding.row1col1.getWidth() / 2;
        binding.row2col1.getLocationOnScreen(coordBall3);
        coordBall3[0] += binding.row1col1.getWidth() / 2;
        binding.row2col2.getLocationOnScreen(coordBall4);
        coordBall4[0] += binding.row1col1.getWidth() / 2;
        binding.row3col1.getLocationOnScreen(coordBall5);
        coordBall5[0] += binding.row1col1.getWidth() / 2;
        binding.row3col2.getLocationOnScreen(coordBall6);
